...
@section('content')
    <div class="carousel">
        ...
        <div id="wowslider-container1">
            <div class="ws_images mt-2">
                <ul>
                    <li><img src="assets/img/slider/casino.png" alt="javascript slider" title="" id="slider1" class="responsive" /></li>
                </ul>
            </div>
    ...
    <div class="container">
        <div class="play mt-3 grid col-4a">
            <a href="{{ route('play') }}"><img src="assets/img/play/lg-casino.png" alt=""></a>
        </div>
    </div>
