                ...
                <div class="daftar-1">
                    <table>
                        <tr>
                            ...
                            <td><input class="sz bg-black" type="text" name="name" value="{{ old('name') }}" id="name" maxlength="15" oninput="value=value.replace(/[^0-9A-Za-z]/g,'')" /></td>
                        </tr>
                        <tr>
                            <td class="ss"></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><input class="sz bg-black" type="password"  name="password"  id="repassword" maxlength="15"></td>
                        </tr>
                        <tr>
                            <td class="ss"></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><input class="sz bg-black" type="password" name="password_confirmation" id="password-confirm" maxlength="15"></td>
                        </tr>
                        <tr>
                            <td class="ss"></td>
                            <td>
                ...
                <div class="daftar-2">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input class="sz bg-black" type="text"  id="referral" name="referral"></td>
                        </tr>
                        <tr>
                            <td class="ss"></td>
                            <td>
