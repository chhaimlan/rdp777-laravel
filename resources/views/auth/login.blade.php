			...
			<div class="slider">
				<!-- Start WOWSlider.com BODY section --> <!-- add to the <body> of your page -->
					<div id="wowslider-container1">
						...
						<li><img src="rdp777/data1/images/slide.jpg" alt="slide1" title="slide" id="wows1_0"/></li>
						<li><img src="rdp777/data1/images/slide2.jpg" alt="slide1" title="slide" id="wows1_0"/></li>
						</ul></div>
					</div>	
					<script type="text/javascript" src="rdp777/engine1/wowslider.js"></script>
					<script type="text/javascript" src="rdp777/engine1/script.js"></script>
