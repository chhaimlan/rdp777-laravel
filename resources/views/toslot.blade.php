...
@section('content')
    <div class="carousel">
        ...
        <div id="wowslider-container1">
            <div class="ws_images mt-2">
                <ul>
                    <li><img src="assets/img/slider/slot.png" alt="javascript slider" title="" id="slider1" class="responsive" /></li>
                </ul>
            </div>
    ...
    <div class="container">
        {{--hide and show img id="ppdetail" --}}
        <div class="play mt-3 grid col-4a">
            <a href="{{ route('slot') }}"><img src="assets/img/play/pp.png" width="214" height="261" alt="" ></a>
            <a href="{{ route('hbslot') }}"><img src="assets/img/play/hb.png" width="214" height="261" alt=""></a>
            <a href="{{ route('pgslot') }}"><img src="assets/img/play/pgsolt.png" width="214" height="261" alt=""></a>
        </div>
